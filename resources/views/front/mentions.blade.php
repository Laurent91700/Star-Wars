        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                ...
                <p id="art01"><a href="#">Haut</a>
                    ...
                    Les présentes Conditions Générales régissent exclusivement votre relation avec STAR WARS.

                    STAR WARS se réserve le droit de modifier à tout moment les Conditions Générales. Elles seront alors applicables dès leur mise en ligne.
                ...
                <p id="art04"><a href="#">Haut</a>
                    ...
                    Une fois votre panier validé, Vous devrez choisir l'adresse et le mode de livraison, et valider votre mode de paiement, cette dernière étape formalisant le contrat de vente avec STAR WARS.

                    Vous avez également la possibilité de passer une commande en une seule étape (« commandez en "1 clic »), dès lors que votre carte de paiement a été préenregistrée et l'adresse et mode de livraison présélectionnés. Cette unique étape formalise le contrat de vente avec STAR WARS.

                    Toute commande vaut acceptation des prix et descriptions des Produits disponibles à la vente.

                    STAR WARS accusera réception de votre commande dès sa validation en vous envoyant un email dans lequel vous trouverez notamment un lien vers les présentes Conditions Générales.

                    Dans certains cas, notamment pour défaut de paiement, adresse erronée ou tout autre problème lié à votre compte, STAR WARS se réserve le droit de bloquer votre commande jusqu'à la résolution du problème.
                ...
                <p id="art05"><a href="#">Haut</a>
                    ...
                    - par carte bancaire : Carte Bleue, e-carte bleue, Visa, Mastercard, carte American Express. Votre compte sera débité à l'expédition des Produits. En cas de Produits épuisés ou indisponibles, le montant de ces Produits ne sera pas débité.
                    - avec la carte "R premium" : La carte "R premium" donne à tout possesseur la possibilité de payer au comptant ou à crédit les Produits : soit lors de l'achat, soit à réception du relevé de compte. La carte donne également accès à d'autres facilités de paiement. Pour connaître les conditions d'attribution de la carte "R premium" et les mentions légales liées à ces facilités de paiement, vous pouvez vous connecter au site Internet www.sofinco.fr ou contacter notre partenaire financier au 0 974 502 504 (du lundi au samedi de 8h à 20h, appel non surtaxé) ou remplir le formulaire de demande de la carte "R premium" en ligne à partir du Site Internet.
                    - avec les cartes Fnac, Printemps, Kangourou, ou Surcouf (uniquement disponibles si vous habitez en France continentale, Corse ou Monaco).
                    - avec votre compte PAYPAL (uniquement disponible pour une livraison en France et Monaco). En choisissant le paiement via PayPal, Vous serez automatiquement dirigé sur votre compte PayPal. Une fois le paiement PayPal validé, Vous pourrez terminer votre commande sur le Site Internet. La carte cadeau STAR WARS ne peut être achetée avec PayPal.
                    - avec une carte cadeau illicado, Spirit of Cadeau, CA DO Carte, Pacifica ou la carte cadeau de STAR WARS : Le montant de vos achats sera dans ce cas débité immédiatement, même en cas d'articles en différé de livraison. Vous devrez renseigner les numéros d'identification figurant sur la carte. Vous pouvez complétez votre paiement carte cadeau avec votre carte R Premium, votre carte bancaire ou une des cartes Fnac, Printemps, Kangourou, ou Surcouf. Reportez-vous aux conditions d'utilisation et restrictions éventuelles applicables à votre carte cadeau. La carte cadeau STAR WARS ne peut être achetée avec les cartes cadeaux.
                    - avec votre cagnotte « Le pot commun ». En choisissant le paiement via « Le pot commun », vous serez automatiquement dirigé sur le site de notre partenaire. Après identification et validation de votre paiement sur lepot commun.fr, vous êtes automatiquement redirigé vers starwars.fr. La carte cadeau STAR WARS ne peut être achetée avec une cagnotte Le pot commun.
                ...
                <p id="art06"><a href="#">Haut</a>
                    ...
                    Les délais de services indiqués ci-après ne sont pas garantis pendant certaines périodes de fortes activités, telles les périodes de soldes, et pour certains Produits de marque (ex. produits Verbaudet, Cyrillus, Ellos, etc.), les Produits sur-mesure, les Produits brodés et personnalisés et les cadeaux gratuits demandés sans commande, qui ne peuvent bénéficier de ces délais de services.
                    - « 24 heures Chez Vous » (coût de 3,95 € en supplément des frais de livraison standard), seulement si la livraison se fait à votre domicile et si la commande est passée du lundi au vendredi avant 12 h pour une livraison à partir du lendemain après-midi (sauf jours fériés). Les commandes passées du vendredi après-midi au dimanche inclus, seront livrées à partir du mardi après-midi.
                    - « Colissimo » (2 à 4 jours à partir de la remise de votre colis de Produits à La Poste), la livraison est effectuée par La Poste.
                    - « Relais Colis » (2 à 4 jours). Pour le retrait de la commande de Produits, une pièce d'identité en vigueur sera exigée, ainsi que, le cas échéant, la carte ayant servi au paiement. A défaut, les Produits commandés ne pourront vous être remis.
                    ...
                    Vous pouvez choisir de faire livrer les Produits à domicile ou dans l’un des points Relais Colis Drive de STAR WARS.
                    Les livraisons à domicile sont effectuées quel que soit l'endroit, notamment à l'étage, sous réserve de la faculté pour les livreurs de disposer du passage nécessaire à la livraison des Produits commandés. Ainsi, préalablement à votre commande, il Vous appartient de vérifier que les Produits peuvent être acheminés à votre étage ou à l’intérieur de votre domicile, notamment en prenant en considération la taille et le volume des portes, de la cage d’escalier ou de l’ascenseur.
                    S’il existe une ou plusieurs contraintes liées aux locaux ou aux moyens d’accès sur le lieu de livraison, Vous devez impérativement contacter le Service Client de STAR WARS pour l’en informer. STAR WARS établira alors un devis en tenant compte de ces contraintes.
                    L’impossibilité d’acheminer les Produits livrés à votre étage ou à l’intérieur de votre domicile, à défaut d'information sur la nécessité de recourir à des moyens spécifiques de livraison, ne saurait engager la responsabilité de STAR WARS. Vous aurez alors la possibilité :

                    De demander au transporteur de reprendre le Produit en application de votre droit de rétractation ;
                    D’accepter la livraison (devant votre domicile ou au pied de votre immeuble) et demander à un prestataire de services, que Vous aurez désigné, qu’il assure la livraison du Produit par la fenêtre ou tout autre moyen, à vos frais.
                    ...
                    - « Livraison dans un Relais Colis Drive » (uniquement pour la France Métropolitaine)
                    Les Produits peuvent être mis à disposition gratuitement dans l’un des 22 points Relais Colis Drive. Vous êtes éligible à ce service si votre adresse se trouve au maximum à 40 Km de l’un de ces points.
                    Pour le retrait de la commande de Produits, une pièce d'identité en vigueur sera exigée, ainsi que, le cas échéant, la carte ayant servi au paiement. A défaut, les Produits commandés ne pourront vous être remis. Vous devrez assurer vous-même le chargement des Produits dans votre véhicule, ainsi de leur transport.
                    Le Produit ne sera disponible dans le point Relais Colis Drive choisi que pendant 14 jours calendaires à partir de son arrivée
                    ...
                    - « Livraison groupée »
                    Si la commande comprend au moins trois Produits disponibles signalés par une camionnette, et d'un montant total minimum de 1500 €, STAR WARS se propose d'effectuer une livraison groupée de l'ensemble de votre commande (habillement, linge de maison, équipement de la maison), sur rendez-vous, à l'adresse de votre choix.
                    Pour en bénéficier, Vous devez indiquer votre numéro de téléphone au moment de la commande pour être rappelé immédiatement et gratuitement ou Vous pouvez appeler au 09 69 36 27 54 (coût d'un appel local).
                    Sur demande de votre part lors de votre commande ou de la prise de rendez-vous, les services de STAR WARS peuvent effectuer gratuitement la reprise de votre ancien appareil électrique ou électronique lors de l'achat effectué en remplacement.
                    - Reprise de l'ancienne literie : proposée pour tout achat de sommier et/ou matelas. La reprise se fait en même temps et sur le même lieu que la livraison. 1 Produit repris pour 1 Produit livré. Coût : 25 € / Produit repris.


                    6.2. Livraison dans les DOM TOM
                    Vous êtes invité à vous reporter à l'onglet « Livraison DOM-TOM » et « Douane » du Site Internet pour obtenir toutes les informations relatives à ce point.
                ...
                <p id="art07"><a href="#">Haut</a>
                    ...
                    Vous disposez d'un droit de rétraction de trente (30) jours calendaires à compter de la date de réception ou de retrait de l'ensemble de votre commande (soit seize (16) jours supplémentaires par rapport au délai légal de rétractation) ou de soixante (60) jours pour les commandes réglées par carte R Premium.
                    Pendant ces délais, Vous pourrez retourner les Produits sans avoir à justifier de motifs, ni à payer de pénalité.
                    ...
                    STAR WARS accusera réception de votre rétractation, par email.
                    Vous devez ensuite retourner les Produits à STAR WARS, au plus tard dans les quatorze (14) jours suivant votre rétractation, soit :
                    - par La Poste à l'adresse suivante : star wars TG5 - 278 rue Colbert - 59200 Tourcoing Les frais de retour via La Poste sont à votre charge (à l'exception d'un Produit défectueux à réception, ou d'une erreur de STAR WARS lors de l'envoi du Produit).
                    - en Relais Colis avec frais à votre charge pour1 euro ou sans aucun frais si le bon de réexpédition avec code barre est collé sur votre colis. Le bordereau de réexpédition vous sera envoyé par email.
                    Pour les Produits volumineux signalés par une camionnette, les Produits retirés en Drive ou pour les Produits ne pouvant pas être retournés par la Poste ou en Relais Colis, star wars organisera gratuitement leur reprise à domicile, si vous appelez au 0969 362 950 (coût d'un appel local).
                    7.2. Remboursement
                    STAR WARS s'engage à vous rembourser la totalité des sommes versées à la réception de votre colis dans ses entrepôts ou dès réception de la preuve de retour de votre colis que Vous nous aurez envoyé à l'adresse suivante : star wars Service Relations Clients, BP 40419, 59057 Roubaix Cedex 1.
                    STAR WARS vous remboursera les Produits retournés, sous réserve du respect des conditions ci-dessus mentionnées, ainsi que les frais de livraison standard « aller » de ces derniers si vous retournez l'ensemble de votre commande.
                    Les livraisons avec suppléments sont remboursées dans la limite des frais de livraison standard.
                    Si Vous ne retournez pas l'intégralité de votre commande et conservez un ou des Produits commandés, le montant des frais de livraison "aller" ne sera pas remboursé par STAR WARS.
                    ...
                    - R Premium, le remboursement sera effectué par le recrédit du compte R Premium. .
                    - Paypal, et que le compte Paypal est toujours actif, le remboursement sera effectué sur ce compte Paypal.
                    - par carte cadeau uniquement (Kadéos, Illicado, Spirit of Cadeaux etc… ) uniquement, le remboursement sera effectué par re-crédit de la carte cadeau utilisée (pensez à la conserver après votre achat)
                    - par carte cadeau et paiement complémentaire (Carte Bancaire, PayPal etc…), le remboursement sera effectué via le moyen de paiement complémentaire utilisé à hauteur du montant réglé par celui-ci puis sur votre carte cadeau.
                    - par bons d'achat (à minima 80% du paiement), le remboursement sera effectué en bons d'achat.
                    ...
                    7.3. Echange
                    Vous avez également, dans le délai de trente (30) jours, la possibilité de demander un échange. Cependant, si vous avez réglé les Produits par carte R Premium, vous bénéficiez d'un délai d'échange de soixante (60) jours.
                    Vous pouvez retourner le Produit à star wars par La Poste ou en Relais Colis.
                ...
                <p id="art08"><a href="#">Haut</a>
                    ...
                    Tous les Produits en vente sur le Site Internet bénéficient de la garantie légale de conformité (L211-1 et suivant du Code de la Consommation) et de la garantie contre les vices cachés (articles 1641 et suivants du Code Civil), vous permettant de renvoyer les Produits livrés défectueux ou non conformes. Vous êtes informé que la société star wars, dont le siège social est 57, rue de Blanchemaille, 59100 Roubaix est le garant de la conformité des Produits au contrat dans le cadre de ces deux garanties légales.
                    ...
                    Dans ce cas, vous pourrez choisir entre la réparation ou le remplacement du Produit, sous réserve des conditions de coût prévues par l’article L 211-9 du Code de la consommation.
                    Vous êtes dispensé de rapporter la preuve de l’existence du défaut de conformité du Produit durant les six mois suivant le délivrance du Produit. Ce délai est porté à vingt-quatre mois à compter du 18 mars 2016, sauf pour les biens d’occasion.
                    Il est rappelé que la garantie légale de conformité s’applique indépendamment de l’éventuelle garantie commerciale qui pourrait vous être consentie par le fabricant ou STAR WARS.
                    Par ailleurs, Vous pouvez décider de mettre en œuvre la garantie contre les défauts cachés de la chose vendue au sens de l’article 1641 du Code civil. Dans cette hypothèse, Vous pourrez choisir entre la résolution de la vente ou un réduction du prix de vente conformément à l’article 1644 du code civil.
                ...
                <p id="art09"><a href="#">Haut</a>
                    ...
                    STAR WARS vous informe que la présence de substances dangereuses dans les équipements électriques et électroniques peut avoir des effets potentiels sur l'environnement et la santé humaine. Ainsi Vous ne devez pas vous en débarrasser avec les déchets municipaux non triés. C'est la raison pour laquelle STAR WARS met à votre disposition un système de collecte spécifique (décret du 20 juillet 2005 relatif à la composition des équipements électriques et électroniques et à l'élimination des déchets issus de ces équipements). Lorsque vous achetez un appareil électrique ou électronique à star wars, cette dernière s'engage à reprendre l'ancien appareil du même type, en état de propreté, débranché et pouvant être manipulé sans danger, au Relais Colis, ou lors de la livraison à domicile, sous réserve d'avoir informé STAR WARS de ce souhait de reprise au moment de la prise de rendez-vous avec Relais Colis. Vous pouvez aussi vous rendre sur le site de eco-systèmes.fr, partenaire de star wars, pour connaitre les points de collecte les plus proches de chez vous.

                    REACH
                    Pour toute question relative à la norme Européenne REACH, l'Utilisateur peut contracter STAR WARS :
                ...
                <p id="art10"><a href="#">Haut</a>
                    ...
                    Cette validation vaut signature et acception expresse de toutes les opérations effectuées sur le Site Internet. Toutefois, en cas d'utilisation frauduleuse de sa carte bancaire, Vous êtes invité, dès le constat de cette utilisation, à contacter le Service Client en appelant le 03 20 69 75 00 (coût d'un appel local depuis un poste fixe, surcoût éventuel opérateur).

                    Les registres informatisés, conservés dans les systèmes informatiques de star wars et de ses partenaires dans des conditions raisonnables de sécurité, seront considérés comme des preuves des communications, des commandes et des paiements intervenus entre Vous et star wars.

                    Les registres informatisés, conservés dans les systèmes informatiques de star wars et de ses partenaires dans des conditions raisonnables de sécurité, seront considérés comme des preuves des communications, des commandes et des paiements intervenus entre les Parties.
                ...
                <p id="art11"><a href="#">Haut</a>
                    ...
                    Ainsi star wars s'engage à décrire avec la plus grande exactitude les produits vendus sur le Site Internet. En revanche, la responsabilité de star wars ne pourra être engagée dans le cas où l'inexécution de ses obligations serait imputable soit au fait imprévisible et insurmontable d'un tiers au contrat soit à un cas de force majeure telle que définie par la jurisprudence française. De même, la responsabilité de star wars ne saurait être engagée pour tous les inconvénients ou dommages inhérents à l'utilisation du réseau Internet, notamment une rupture de service, une intrusion extérieure ou la présence de virus informatiques.
                ...
                <p id="art14"><a href="#">Haut</a>
                    ...
                    Le Site Internet est conforme à la législation française, et en aucun cas, STAR WARS ne donne de garantie de conformité à la législation locale qui vous serait applicable, dès lors que Vous accédez au Site Internet à partir d'autres pays.
                </p>
            </div>
        </div>
    </div>
